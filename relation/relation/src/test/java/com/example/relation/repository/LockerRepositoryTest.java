...
import com.example.relation.repository.sports.SportsMemberReopsitory;
...
public class LockerRepositoryTest {
    ...
    @Autowired
    private SportsMemberReopsitory sportsMemberRepository;
    ...
    public void testDelete2() {
        // 4번 locker 삭제(무결성제약조건 - 4번 locker를 할당받은 member 존재)
